...
import { white, grey, light_dark } from "../utils/colors";
...
const BottomNavigation = ({ state, descriptors, navigation }) => {
  return (
    <Footer style={{backgroundColor: Platform.OS === "ios" ? null : light_dark}}>
      <LinearGradient colors={["#141e30", "#243b55"]} style={styles.gradient}>
        <FooterTab style={{backgroundColor: Platform.OS ==="ios"? null : light_dark}}>
